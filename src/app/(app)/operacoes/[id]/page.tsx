        ...
        <div className="mb-6">
          <Card>
            ...
            <CardContent className="grid grid-cols-2 gap-4 text-sm sm:grid-cols-4">
              <div>
                <p className="text-secondary-foreground">Caixa inicial</p>
                <p className="text-lg font-semibold text-foreground">
                  {formatCurrency(operation.opening_cash)}
                </p>
              </div>
              <div>
                <p className="text-secondary-foreground">Esperado em dinheiro</p>
                <p className="text-lg font-semibold text-foreground">
                  {operation.expected_cash != null ? formatCurrency(operation.expected_cash) : "—"}
                </p>
              </div>
              <div>
                <p className="text-secondary-foreground">Contado</p>
                <p className="text-lg font-semibold text-foreground">
              ...
              <div>
                <p className="text-secondary-foreground">Diferença</p>
                <p
              ...
              {operation.notes && (
                <p className="col-span-full text-xs text-secondary-foreground">{operation.notes}</p>
              )}
            </CardContent>
          </Card>
        </div>
